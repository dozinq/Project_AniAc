...
4. 직원 **'카이'**를 클릭한다면, 카이는 사용자의 영화 성향에 대해 파악하고 그에 맞는 영화들을 추천해 줄 것입니다.
...
작성 할 내용: 왜 해당 repository를 만들어 게시하게 되었는지, 느낀 점(모노가타리 툴 사용 못한 점, 스토리를 구성하며 느꼈던 점(고충), 앵커)
